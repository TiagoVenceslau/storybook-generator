...
const styleDescriptions: { [key: string]: string } = {
  ...
  'Coloring Book': 'Simplified black-and-white drawings with clear outlines, designed for filling in with colors, resembling children’s or adult coloring books',
  'Line Art': 'Clean monochrome illustration emphasizing outlines, contours, and minimal shading, often used for sketches, technical drawings, or minimalist artwork',
